...
make
cd ../../..
cp ./RP2040MacropadHidSample/src/build/macropad.uf2 ./macropad.uf2
...
echo -e "  10. Open an Explorer window to the build directory (or where this script is), and copy macropad.uf2 to the Macropad removeable device. Device should automatically remove itself and reboot."
